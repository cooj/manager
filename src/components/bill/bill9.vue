...
<template>
  <BillBox>
    <template v-slot:title>
      <div style="display: inline-block; border-bottom: 1px solid">
        银行本票申请书（存&emsp;根）NO
        <a-input
          style="width: 150px"
          type="text"
    ...
    <template v-slot:top>
      <div class="time">
        <i class="red" style="margin-left: 5px">*</i>申请日期：
        <span class="year">
          <a-input
            type="text"
    ...
    <template v-slot:body>
      <tr>
        <td colspan="4">
          <div class="text-center"><i class="red">*</i>申&nbsp;请&nbsp;人</div>
        </td>
        <td colspan="8">
          <a-input
            type="text"
        ...
        <td colspan="4">
          <div class="text-center"><i class="red">*</i>收&nbsp;款&nbsp;人</div>
        </td>
        <td colspan="9">
          <a-input
            type="text"
      ...
      <tr>
        <td colspan="4">
          <div class="text-center"><i class="red">*</i>账号或地址</div>
        </td>
        <td colspan="8">
          <a-input
            type="text"
      ...
      <tr>
        <td colspan="4">
          <div class="text-center"><i class="red">*</i>用&emsp;途</div>
        </td>
        <td colspan="8">
          <a-input
            type="text"
        ...
        <td colspan="4">
          <div class="text-center"><i class="red">*</i>代理付款行</div>
        </td>
        <td colspan="9">
          <a-input
            type="text"
      ...
      <tr>
        <td colspan="4">
          <div class="text-center">款项金额</div>
        </td>
        <td colspan="12">
          <div class="mon_lt">
            <em><i class="red">*</i>人民币(大写)</em>
            <span>
              <a-input
                type="text"
      ...
      <tr>
        ...
        <td colspan="13">
          <div class="t_intro2">
            ...
            <div>
              对方科目<span class="" style="width:50%;">
                <a-input
                  type="text"
            ...
            <div>
              财务主管<span class="" style="width:25%;">
                <a-input
                  type="text"
