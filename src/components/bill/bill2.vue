...
<template>
    <BillBox>
        <template v-slot:title>结算业务申请书</template>
        <template v-slot:top>
            <div class="time">
        ...
        <template v-slot:body>
            <tr>
                ...
                <td colspan="8">
                    <a-radio-group v-model:value="formData.form.val4.value">
                        <a-radio value="1">电汇</a-radio>
                        <a-radio value="2">信汇</a-radio>
                        <a-radio value="3">汇票</a-radio>
                        <a-radio value="4">本票</a-radio>
                ...
                <td colspan="8">
                    <a-radio-group v-model:value="formData.form.val5.value">
                        <a-radio value="1">普通</a-radio>
                        <a-radio value="2">加急</a-radio>
                    </a-radio-group>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="14" rowspan="2" class="pos bor0">
                    <div class="intro1">上例款项及相关费用请从我账户内支付</div>
                </td>
                <td colspan="3">
                    <div class="text-center">支付密码</div>
                </td>
                <td colspan="7">
            ...
            <tr>
                <td colspan="13" class="bor" style="border-left: 0;">
                    <div class="intro2">
                        附加信息及用途:
                        <a-textarea
