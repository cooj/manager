...
<template>
  <BillBox>
    <template v-slot:title>现金缴纳单（回单）</template>
    <template v-slot:top>
      <div class="time">
        <i class="red" style="margin-left: 5px">*</i>缴纳日期：
        <span class="year">
          <a-input
            type="text"
        ...
        <span class="month">
          <a-input
            type="text"
            v-model:value="formData.form.val2.value"
            :maxlength="2"
          /> </span
        >月
        <span class="date">
    ...
    <template v-slot:body>
      <tr>
        <td rowspan="3">
          <div class="writ_lr">收款单位</div>
        </td>
        <td colspan="4">
          <div class="text-center">全&emsp;称</div>
        </td>
        <td colspan="8">
          <a-input
            type="text"
      ...
      <tr>
        <td colspan="4">
          <div class="text-center">账&emsp;号</div>
        </td>
        <td colspan="8">
          <a-input
            type="text"
      ...
      <tr>
        <td colspan="4">
          <div class="text-center">开户银行</div>
        </td>
        <td colspan="8">
          <a-input
            type="text"
        ...
        <td colspan="14">
          <div class="mon_lt">
            ...
            <span>
                                <a-input
            type="text"
            v-model:value="formData.form.val33.value"
            :maxlength="50"
          />
            </span>
          </div>
      ...
      <tr>
        <td colspan="14" style="padding: 0">
          <TableBox :chunk="22">
            <tr>
              <td colspan="2">
                <div class="text-center">票面</div>
              </td>
              <td colspan="2">
                <div class="text-center">伍拾</div>
              </td>
              <td colspan="2">
                <div class="text-center">拾元</div>
              </td>
              <td colspan="2">
                <div class="text-center">贰元</div>
              </td>
              <td colspan="2">
                <div class="text-center">壹元</div>
              </td>
              <td colspan="2">
                <div class="text-center">伍角</div>
              </td>
              <td colspan="2">
                <div class="text-center">贰角</div>
              </td>
              <td colspan="2">
                <div class="text-center">壹角</div>
              </td>

              <td colspan="2">
                <div class="text-center">伍分</div>
              </td>
              <td colspan="2">
                <div class="text-center">贰分</div>
              </td>
              <td colspan="2">
                <div class="text-center">壹分</div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="text-center">整把</div>
              </td>
              <td colspan="2">
        ...
        <td colspan="14" rowspan="3">
          <div>
            ...
            <div class="in-text">
              <a-input
                type="text"
                v-model:value="formData.form.val30.value"
                :maxlength="20"
              />
            </div>
          </div>
          <div>
            ...
            <div class="in-text">
              <a-input
                type="text"
                v-model:value="formData.form.val31.value"
                :maxlength="20"
              />
            </div>
          </div>
          <div>
            ...
            <div class="in-text">
              <a-input
                type="text"
                v-model:value="formData.form.val32.value"
                :maxlength="20"
              />
            </div>
          </div>
