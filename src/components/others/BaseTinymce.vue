...
const props = defineProps({
  ...
  toolbar: {
    ...
    default: [
      ...
      "styleselect formatselect fontselect fontsizeselect |  table image axupimgs media emoticons charmap hr pagebreak insertdatetime  selectall visualblocks searchreplace |codesample code print preview | indent2em lineheight formatpainter",
    ],
...
const init = reactive({
  language_url: base+"langs/zh_CN.js", //引入语言包文件
  language: "zh_CN", //语言类型
  ...
  base_url: base, //定义一下基础路径,部分文件迁到/public/tinymce,解决控制器报错GET http://localhost:3000//skins/content/default/content.css net::ERR_ABORTED 404 (Not Found)
  ...
  //自己新增的插件
  external_plugins: {
    indent2em: base+"plugins/indent2em/plugin.js", //首行缩进
    axupimgs: base+"plugins/axupimgs/plugin.js", //多图上传
  },
