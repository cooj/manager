...
export { jmMess, types,toFixed, getParams, getRandomNum, updateUrl, throttle, debounce, formatTime, timeFormat, strCut, ltrim, rtrim, trim, isMobile, ajax, goTop, effectText, newBrowser, openIframe, copy } //可解构

// export default { types, getParams, throttle, debounce, formatTime, timeFormat, strCut, ltrim, rtrim, trim, isMobile, ajax, goTop, effectText, newBrowser, openIframe } //不可解构
